(function(){
  ...
  var STORAGE_KEY = 'yasna_negotiations_trainer_v6';
  ...
  function renderSim(){
    ...
    els.thinkingMap.innerHTML =
      '<div class="np-lesson-route" aria-label="Маршрут урока">' +
        ...
        '<div><span>2</span><strong>Замечаем</strong><p>' + esc(model.skill) + '</p></div>' +
        '<div><span>3</span><strong>Делаем ход</strong><p>Выбираем ответ без давления</p></div>' +
        '<div><span>4</span><strong>Разбираем</strong><p>Что стало с доверием</p></div>' +
      '</div>';
